...
Revision ID: d34fc03e4e3d
Revises: 297121bd471b
Create Date: 2025-04-13 00:23:24.954445
...
revision: str = 'd34fc03e4e3d'
down_revision: Union[str, None] = '297121bd471b'
...
def upgrade() -> None:
    ...
    op.create_index('idx_agent_feedback_created_at', 'agent_feedback', ['created_at'], unique=False, postgresql_ops={'created_at': 'DESC'})
    ...
    op.alter_column('calendar_tasks', 'updated_at',
               ...
               nullable=False,
               existing_server_default=sa.text('CURRENT_TIMESTAMP'))
    op.alter_column('conversation_messages', 'sender',
    ...
    op.create_unique_constraint('unique_conversation_project', 'conversations', ['project_id'])
    ...
    op.create_index('idx_integration_logs_created_at', 'integration_logs', ['created_at'], unique=False, postgresql_ops={'created_at': 'DESC'})
...
def downgrade() -> None:
    ...
    op.alter_column('invite_codes', 'code',
               ...
               existing_nullable=False)
    op.drop_index('idx_integration_logs_created_at', table_name='integration_logs', postgresql_ops={'created_at': 'DESC'})
    ...
    op.drop_index('idx_agent_feedback_created_at', table_name='agent_feedback', postgresql_ops={'created_at': 'DESC'})
