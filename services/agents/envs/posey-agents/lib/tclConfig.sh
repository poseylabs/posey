...
# installed.
TCL_PREFIX='/Volumes/Projects/posey/services/agents/envs/posey-agents'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Volumes/Projects/posey/services/agents/envs/posey-agents'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Volumes/Projects/posey/services/agents/envs/posey-agents/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_c2tv246l1c/croot/tk_1714770557340/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Volumes/Projects/posey/services/agents/envs/posey-agents=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Volumes/Projects/posey/services/agents/envs/posey-agents/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Volumes/Projects/posey/services/agents/envs/posey-agents/lib -L/Volumes/Projects/posey/services/agents/envs/posey-agents/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Volumes/Projects/posey/services/agents/envs/posey-agents/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Volumes/Projects/posey/services/agents/envs/posey-agents/include'
...
TCL_PACKAGE_PATH='{/Volumes/Projects/posey/services/agents/envs/posey-agents/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Volumes/Projects/posey/services/agents/envs/posey-agents/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Volumes/Projects/posey/services/agents/envs/posey-agents/lib/libtclstub8.6.a'
