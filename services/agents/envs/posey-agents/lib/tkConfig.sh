...
# installed.
TK_PREFIX='/Volumes/Projects/posey/services/agents/envs/posey-agents'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Volumes/Projects/posey/services/agents/envs/posey-agents'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Volumes/Projects/posey/services/agents/envs/posey-agents/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Volumes/Projects/posey/services/agents/envs/posey-agents/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Volumes/Projects/posey/services/agents/envs/posey-agents/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Volumes/Projects/posey/services/agents/envs/posey-agents/lib/libtkstub8.6.a'
